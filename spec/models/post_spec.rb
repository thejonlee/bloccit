...
# - test whether post has attributes named title and body
  ...
  describe "voting" do
    ...
    describe "#update_rank" do
      # determine age of post by subtracting a standard time (epoch) from created_at time.
      # divide distance in seconds since epoch by seconds in a day to give us age in days.
      # add points to age (one day passing equals one down vote)
