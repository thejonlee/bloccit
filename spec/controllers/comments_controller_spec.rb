...
RSpec.describe CommentsController, type: :controller do
  ...
  # specs for guest users, w/redirect to sign-in if they attempt to create or delete a comment
  context "guest" do
  ...
  # spec for members, redirect to posts show view if try to delte other comments
  ...
  # test for members creating new comments and deleting their own
  ...
  # test that admin can create/delete any comment
