...
RSpec.describe PostsController, type: :controller do
  ...
  describe "GET #index" do
    ...
    it "assigns [my_post] to @posts" do
      get :index
      # #9 - assigns is a method in ActionContorller::TestCase that gives the test acccess to "instance variables assigned in the action that are available for the view"
 ...
 # #2
   ...
   describe "DELETE destroy" do
     it "deletes the post" do
       ...
       # #6 - search database for post w/id = my_post.id.  Returns an array.
     ...
     it "redirects to posts index" do
       delete :destroy, params: { id: my_post.id }
       # #7 - redirect to posts index view after deleting a post 
