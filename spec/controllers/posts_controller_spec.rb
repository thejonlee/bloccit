...
RSpec.describe PostsController, type: :controller do
 ...
 # define tests for other CRUD actions
     describe "GET new" do
       it "returns http redirect" do
         get :new, params: { topic_id: my_topic.id }
 # expect redirect if guests attempt to create/update/delete a post
   ...
   context "signed-in user" do
     ...
     describe "DELETE destroy" do
       it "deletes the post" do
         delete :destroy, params: { topic_id: my_topic.id, id: my_post.id }
         # search database for post w/id = my_post.id.  Returns an array.
